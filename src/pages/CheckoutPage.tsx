        ...
        <Row>
          <Col md={8}>
            ...
            <div className="d-flex align-items-center justify-content-between my-2">
              <div>
                <img src="/camera1.jpg" alt="Canon" width={50} className="me-2" />
            ...
            <div className="d-flex align-items-center justify-content-between my-2">
              <div>
                <img src="/camera2.jpg" alt="Sony" width={50} className="me-2" />
                Body Sony A6400
              </div>
              <div>500,000 đ</div>
            </div>
          ...
          <Col md={4} className="text-center">
            <img src="/avatar.png" alt="user" className="img-fluid" />
          </Col>
        </Row>
